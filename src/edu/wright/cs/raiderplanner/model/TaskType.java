...
public class TaskType extends ModelEntity {
	...
	/**
	 * Searches task database for given task type.
	...
	/**
	 * Searches task database to see if given task type exists.
	...
	/**
	 * Searches task database to see if given task name exists.
