...
public class Milestone extends ModelEntity {
	...
	/**
	 * Computes progress based on Task weighting and Tasks completed. Used for JavaFX.
	 *
	...
	/**
	 * Returns a String representation of completed Tasks (e.g. 3/4). Used in JavaFX.
	 *
	...
	/**
	 * Returns a String representation of the Deadline for this Milestone. Used in JavaFX.
	 *
	...
	public void setDeadline(LocalDate date) {
		this.deadline
				.setDate(date.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "T00:00:01Z");
	}
	...
	public Milestone(String name, String details, LocalDate deadline) {
		...
		this.deadline = new Deadline(
				deadline.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "T00:00:01Z");
	}
}
